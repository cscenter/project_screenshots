...
const output_directory_name = "red_documents2";
...
puppeteer.launch().then((browser) => {
  ...
  browser.newPage().then((page) => {
    ...
    (async () => {
      ...
      for (let url of urls_list.slice(-300,-200)) {
          if (url) {
            ...
            try {
              ...
              number_css = Math.floor(Math.random() * 2);
               console.log("css style: css", number_css);
              await page.addStyleTag({path: "static/red" + number_css + ".css"});
