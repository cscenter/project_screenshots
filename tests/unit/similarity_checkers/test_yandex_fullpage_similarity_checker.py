...
class TestYandexFullpageSimilarityChecker(UnitTest):
    def setUp(self):
        self.analyser = YandexFullpageSimilarityChecker()

    def test_does_not_fire_on_good_screenshot1(self):
        self.assert_no_anomaly("similarity_checkers/good1.png")

    def test__fires_on_screenshot_wo_header_and_footer(self):
        self.assert_has_anomaly("similarity_checkers/wo_hf.png")
    ...
    def test_does_fires_on_google(self):
        self.assert_has_anomaly("similarity_checkers/google.png")

    def test_does_fires_on_twitter(self):
        self.assert_has_anomaly("similarity_checkers/long1.png")
