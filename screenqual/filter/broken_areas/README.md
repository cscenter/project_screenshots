...
Для нахождения недогруженных видео вначале собирается тренировочное множество на основе которого тренируется простой классификатор, основаннай на гистограммах. Далее на основе данного классификатора прнимается решение, является ли скриншот битым.
